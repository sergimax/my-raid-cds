...
```
src/
├── components/       # app-header, tracker-layout, raid-tracker-main, character-form, character-edit-dialog (+ character-spec-gear-import-section, character-edit-spec-gear), character-spec-gear-fields, spec-option-label, dungeon-form, dungeon-edit-dialog, dungeon-customization-fields, export-panel, bis-lists-panel, gear-hint-tooltip, wow-item-link (+ item-link-styles.ts), stored-gear-item-line, item-tooltip-locale-toggle, tracker-controls, …
