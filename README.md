...
- **Export** — Copy a raid roster of characters still missing CD for visible (filtered) rows; optional minimum GS slider (`≥ 5.6`, etc.) omits lower-GS specs from lines; role checkboxes filter by tank, healer, melee DPS, or ranged DPS.
