...
| `npm run build:wow-data` | Regenerate bundled item names, gear slots, equip metadata, raid loot, item drop sources (boss + raid per item id), and tier sets from `scripts/wowsims-db.json` (use `--skip-ru` to skip WoWRoad Russian name fetch) |
