...
export const ruMessages: Messages = {
  ...
  gearPickPanel: {
    ...
    instructions:
      "Настройте правила софтов рейда, выберите одного персонажа и спек, распределите свои софты и чужие заявки по BiS-апгрейдам из отфильтрованных рейдов, затем скопируйте список",
    rulesTitle: "Правила софт резерва в рейде",
    rulesHelper: "Сколько софтов разрешено в рейде и как они работают: +100 или переролл",
    ...
    systemRerollAria:
      "Каждый, кто зявляет софт, получает 1 обычный /roll плюс /roll за каждый софт; побеждает лучший результат",
