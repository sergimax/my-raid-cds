...
export const ruMessages: Messages = {
  ...
  gearPickPanel: {
    title: "Подбор снаряжения",
    closeAria: "Закрыть панель подбора снаряжения",
    instructions:
      "Выберите одного персонажа и спек, настройте правила софтов рейда, распределите свои софты и чужие заявки по BiS-апгрейдам из отфильтрованных рейдов, затем скопируйте список",
    rulesTitle: "Правила софтов",
    rulesHelper: "Сколько софтов разрешено в рейде и как они работают: +100 или доп. /roll",
    maxSoftsLabel: "Макс. софтов",
    maxSoftsAria: "Максимум софт-роллов в этом рейде",
    systemLabel: "Система софтов",
    ...
    dungeonFilterHelper:
      "Использует поиск в шапке таблицы. Цели софтов берутся из совпадающих строк рейдов",
    itemsTitle: "Цели софтов",
    itemsHelper: "BiS и варианты BiS из отфильтрованных рейдов. Назначьте свои софты и учтите чужие",
    itemsEmptyNoSelection: "Выберите персонажа и спек, чтобы увидеть цели",
    itemsEmptyNoGear: "Импортируйте шмот для этого спека, чтобы увидеть цели",
    itemsEmptyNoBis: "Выберите BiS-список для этого спека, чтобы увидеть цели",
    itemsEmptyNoItems: "Нет BiS-апгрейдов в отфильтрованных рейдах для этого спека",
    mySoftsLabel: "Мои софты",
    mySoftsAria: "Софты на {{item}}",
    decreaseMySoftsAria: "Уменьшить софты на {{item}}",
    increaseMySoftsAria: "Увеличить софты на {{item}}",
    othersTitle: "Чужие софты на предмет",
    othersWeightLabel: "×{{weight}}",
    othersWeightAria: "Сколько игроков зовут ×{{weight}} софтов на {{item}}",
    ...
    kindVariant: "Вариант",
    copyTitle: "Софт-кол",
    copyHelper: "Предметы, на которые вы назначили софты. Скопируйте и отправьте в рейд",
    copyEmpty: "Назначьте софты хотя бы на один предмет",
    copyLine: "Скопировать",
    copyLineAria: "Скопировать список софт-кола",
    copied: "Скопировано",
