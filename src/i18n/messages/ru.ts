...
export const ruMessages: Messages = {
  ...
  exportPanel: {
    ...
    instructions:
      "Сузьте до одного рейда (поиск в таблице), выберите нужные спеки и отфильтруйте по роли и GS. Если ниже появилась строка — скопируйте её и отправьте рейдлидеру в личку.",
    noCharacters: "Добавьте персонажа для формирования сводки.",
    exportLinesTitle: "Готов записаться",
    exportLinesHelper:
    ...
    roleMeleeDps: "МДД",
    roleRangedDps: "РДД",
    roleTankAria: "Включить танковые спеки в экспорт",
    roleHealerAria: "Включить хил-спеки в экспорт",
    roleMeleeDpsAria: "Включить мили ДД в экспорт",
    roleRangedDpsAria: "Включить рейндж ДД в экспорт",
