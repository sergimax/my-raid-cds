export const enMessages = {
  ...
  gearPickPanel: {
    title: "Gear pick",
    closeAria: "Close gear pick panel",
    instructions:
      "Pick one character and spec, set the raid soft-roll rules, assign your softs and competing calls on BiS upgrades from filtered raids, then copy the soft call list",
    rulesTitle: "Soft-roll rules",
    ...
    dungeonFilterHelper:
      "Uses the dungeon search in the table header. Soft targets come from matching raid rows",
    itemsTitle: "Soft targets",
    itemsHelper: "BiS and BiS-variant upgrades from filtered raids. Assign your softs and track others",
    itemsEmptyNoSelection: "Select a character and spec to see soft targets",
    itemsEmptyNoGear: "Import gear for this spec to see soft targets",
    itemsEmptyNoBis: "Select a BiS list for this spec to see soft targets",
    itemsEmptyNoItems: "No BiS upgrades in the filtered raids for this spec",
    mySoftsLabel: "My softs",
    mySoftsAria: "Soft rolls to spend on {{item}}",
    decreaseMySoftsAria: "Decrease softs for {{item}}",
    increaseMySoftsAria: "Increase softs for {{item}}",
    othersTitle: "Softs already called by others",
    othersWeightLabel: "×{{weight}}",
    othersWeightAria: "Number of players calling ×{{weight}} softs on {{item}}",
    ...
    copyEmpty: "Assign softs to at least one item to build a soft call",
    copyLine: "Copy",
    copyLineAria: "Copy soft call list",
    copied: "Copied",
