export const enMessages = {
  ...
  exportPanel: {
    ...
    instructions:
      "Filter dungeons with the table search, then copy lines below — one per matching raid listing characters still without CD (toggle off). Check which specs to include for each character. Optionally set a minimum gear score to omit lower-GS specs from export lines.",
    noCharacters: "Add a character to build a status summary.",
    exportText: "Export text",
    minGearScore: "Min gear score",
    minGearScoreHelper: "Only include checked specs at or above this GS. Leave empty for no filter.",
    minGearScoreInvalid: "Enter a whole number from {{min}} to {{max}}, or leave empty.",
