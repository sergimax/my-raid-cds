...
- **Export result lines:** Per-raid signup lines replace the read-only textarea (raid label + characters, **Copy for PM** per line; primary button when only one raid matches).
